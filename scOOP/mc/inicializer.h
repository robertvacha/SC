...
private:
    ...
    void initChainLists();
    void initMolecules(Molecule molecules[MAXMT]);
    ...
    /**
     * @brief initialize parameters for interactions
     */
    void initParams();
     ...
     * @return
     */
    int topDealoc(char *sysnames[MAXN], long **sysmoln, Molecule * molecules);
