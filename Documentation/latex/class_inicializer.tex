...
int \hyperlink{class_inicializer_a6dad809b18ec2149abc33d71736b1e7b}{fill\+Mol} (char $\ast$molname, char $\ast$pline, \hyperlink{class_molecule}{Molecule} $\ast$molecules)
...
\item 
\hyperlink{class_topo}{Topo} $\ast$ \hyperlink{class_inicializer_a9ce346ffecd5ecf76bd4c1c68a3060f7}{topo}
\item 
\hyperlink{class_sim}{Sim} $\ast$ \hyperlink{class_inicializer_a8d55514c1121c5d3edbbd4fdfb32db65}{sim}
\item 
...
Create lists for chain operations\+: Connectivity list where it is written for each sc with which sc it is connected. The order is important because spherocylinders have direction First is interacting tail then head. Chain list where particles are assigned to chains to which they belong 
...
\hypertarget{class_inicializer_ada4af3101e860931ce8f1c52d0bd7555}{\index{Inicializer@{Inicializer}!top\+Dealoc@{top\+Dealoc}}
...
\item[{long $\ast$$\ast$}]{sysmoln}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{class_inicializer_ada4af3101e860931ce8f1c52d0bd7555}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{class_inicializer_ada4af3101e860931ce8f1c52d0bd7555_icgraph}
\end{center}
\end{figure}
