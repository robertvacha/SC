...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{structures_8h__incl}
\end{center}
\end{figure}
...
class \hyperlink{class_molecule}{Molecule}
...
\item 
class \hyperlink{class_disp}{Disp}
\begin{DoxyCompactList}\small\item\em Define step size and acceptance ratio statistics. \end{DoxyCompactList}\item 
class \hyperlink{class_ia__param}{Ia\+\_\+param}
\begin{DoxyCompactList}\small\item\em Contatins properties and parameters of particle types. \end{DoxyCompactList}\item 
class \hyperlink{class_exters}{Exters}
\item 
class \hyperlink{class_topo}{Topo}
